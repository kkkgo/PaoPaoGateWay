...
services:
  paopaodns:
    ...
    ports:
      ...
      - "7889:7889/tcp"
```
需要注意的是，一小部分应用不走域名而是IP直连，比如某些聊天软件应用，你只需要添加少量对应的的静态路由即可。  
